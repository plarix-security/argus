...
|--------|-----------|-----------------|---------------|--------|-------|
| 00-langgraph-production | python | Operational Python scan with no failed files plus CEE validation | 85 cees, 80 afb04 findings (8C/46W/26I), exit 2, analyzed 12, skipped 0, failed 0 | PASS | CEE validation passed with 85 inventoried events |
